    ...
    <div className="activation-container">
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 5px 0', fontWeight: 'bold', color: '#0369a1' }}>
                {card.fullName
                  ...
                  : "⚠️ No existing application — blank record created"}
              </p>
            ...
            <div className="card-info-grid">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={card.cvv}
                  onChange={(e) =>
                    setCard({ ...card, cvv: formatCVV(e.target.value) })
                  }
                />
              </div>
            </div>
      ...
      <style jsx="true">{`
        ...
        @media (min-width: 481px) {
          .activation-container { padding: 20px; align-items: center; }
          .activation-card { padding: 30px; margin: 0; }
          .title { font-size: 26px; }
          .input-group { flex-direction: row; }
          .email-input { flex: 1; }
          .fetch-btn { width: auto; min-width: 180px; }
          .status-header { flex-direction: row; align-items: center; }
          .status-controls { flex-direction: row; }
          .status-btn { min-width: 100px; }
        }
        @media (min-width: 769px) {
          .activation-card { padding: 40px; }
          .card-info-grid { grid-template-columns: repeat(3, 1fr); }
          .save-btn { max-width: 300px; }
        }
        @media (min-width: 1025px) {
          .title { font-size: 28px; }
          .card-info-grid { grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); }
        }
        @media (max-width: 480px) {
          .activation-card { padding: 20px; border-radius: 16px; }
          .title { font-size: 22px; margin-bottom: 20px; }
          .email-input, .card-input, .card-select { padding: 12px 14px; font-size: 15px; }
          .fetch-btn, .save-btn { padding: 14px; font-size: 15px; }
          .section-title { font-size: 18px; }
          .status-section { padding: 16px; }
          .card-preview-container { transform: scale(0.85); margin-bottom: 16px; }
        }
        @media (max-width: 320px) {
          .activation-container { padding: 12px; }
          .activation-card { padding: 16px; border-radius: 14px; }
          .title { font-size: 20px; margin-bottom: 16px; }
          .label { font-size: 12px; }
          .email-input, .card-input, .card-select { padding: 10px 12px; font-size: 14px; }
          .fetch-btn, .save-btn { padding: 12px; font-size: 14px; }
          .section-title { font-size: 16px; }
          .card-preview-container { transform: scale(0.75); }
        }
        @media (max-height: 600px) and (orientation: landscape) {
          .activation-container { align-items: flex-start; padding-top: 20px; padding-bottom: 20px; }
          .activation-card { margin: 20px 0; }
          .card-preview-container { transform: scale(0.8); }
        }
