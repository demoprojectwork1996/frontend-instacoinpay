          ...
          <div className="blog-header">
            <div className="blog-header-text">
              ...
              <p className="blog-subtitle">
                Real-time crypto news, market analysis & blockchain updates.
              </p>
              ...
              <div className="blog-stats">
                ...
                {blogError && (
                  <span className="blog-error-stat">⚠️ {blogError}</span>
                )}
              </div>
            </div>
          ...
          {blogLoading ? (
            ...
            <div className="blog-grid">
              ...
              {blogArticles.slice(0, 2).map((article) => (
                ...
                >
                  {article.trending && (
                    <div className="blog-card-badge">🔥 TRENDING</div>
                  )}
                  ...
                  <div className="blog-card-image">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.target.src = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS61vWA02O17jGsJNbvCDJinRHI7YoUphGD9w&s";
                      }}
                    />
