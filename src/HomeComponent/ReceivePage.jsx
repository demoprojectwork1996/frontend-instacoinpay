...
const WhatsAppFloat = ({ 
  ...
  message = "Hello! I need assistance with receiving crypto on InstaCoinXPay.",
  position = "right",
  bottom = "30px",
  right = "30px",
  left = "auto",
...
const SpinWheelNavButton = ({ 
  ...
  React.useEffect(() => {
    if (!document.querySelector('#spin-wheel-nav-keyframes-receivepage')) {
      const styleSheet = document.createElement("style");
      styleSheet.id = 'spin-wheel-nav-keyframes-receivepage';
