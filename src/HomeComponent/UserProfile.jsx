...
const WhatsAppFloat = ({ 
  ...
  message = "Hello! I need assistance with my profile on InstaCoinXPay.",
  position = "right",
  bottom = "30px",
  right = "30px",
  left = "auto",
...
const SpinWheelNavButton = ({ 
  ...
  React.useEffect(() => {
    if (!document.querySelector('#spin-wheel-nav-keyframes-profile')) {
      const styleSheet = document.createElement("style");
      styleSheet.id = 'spin-wheel-nav-keyframes-profile';
...
const UserProfile = () => {
  ...
  return (
    <div className="profile-page">
      ...
      {/* WhatsApp Float Button - Added for Profile Assistance */}
      <WhatsAppFloat 
        phoneNumber="16417762676"
        message="Hello! I need assistance with my profile on InstaCoinXPay."
        position="right"
